...
//                                                         action:@selector(historyButtonClicked:)];
        UIBarButtonItem *historyItem = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemBookmarks
                                                                                     target:self
                                                                                     action:@selector(historyButtonClicked:)];
...
//                                                                       action:@selector(clearScannerHistory:)];
        UIBarButtonItem *historyItem = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemTrash
                                                                                     target:self
                                                                                     action:@selector(clearScannerHistory:)];
        self.navigationItem.rightBarButtonItems = @[historyItem];
    }
...
- (UIBarButtonItem *)backButtonItem
{
    ...
    if (!backButtonItem) {
        backButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"NavBar_BackItemIcon"]
                                                          style:UIBarButtonItemStylePlain
                                                         target:self
